# Standalone report format — focus-visibility-audit
...
fix-pattern entries you cited (copied in from `references/fix-patterns.md`), a note recommending `/keyboard-dropdown-audit` if custom
